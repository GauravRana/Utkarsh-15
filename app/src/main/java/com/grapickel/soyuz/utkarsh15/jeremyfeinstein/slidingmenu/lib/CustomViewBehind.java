...
public class CustomViewBehind extends ViewGroup {
    ...
    public void drawSelector(View content, Canvas canvas, float openPercent) {
        if (this.mSelectorEnabled && this.mSelectorDrawable != null && this.mSelectedView != null && ((String) this.mSelectedView.getTag(C0148R.id.selected_view)).equals("CustomViewBehindSelectedView")) {
            canvas.save();
    ...
    public void setSelectedView(View v) {
        if (this.mSelectedView != null) {
            this.mSelectedView.setTag(C0148R.id.selected_view, null);
            this.mSelectedView = null;
        }
        if (v != null && v.getParent() != null) {
            this.mSelectedView = v;
            this.mSelectedView.setTag(C0148R.id.selected_view, "CustomViewBehindSelectedView");
            invalidate();
        }
    }
