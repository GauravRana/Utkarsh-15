...
public class CustomViewAbove extends ViewGroup {
    ...
    private static final Interpolator sInterpolator = new C01471();
    ...
    class C01471 implements Interpolator {
        C01471() {
        }
    ...
    class C01802 extends SimpleOnPageChangeListener {
        C01802() {
        }
    ...
    void initCustomViewAbove() {
        ...
        setInternalPageChangeListener(new C01802());
    ...
    void smoothScrollTo(int x, int y, int velocity) {
        ...
        if (velocity > 0) {
            ...
            duration = (int) ((1.0f + (((float) Math.abs(dx)) / ((float) width))) * 100.0f);
